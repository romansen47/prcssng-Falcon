...
public class DoublePlainGun extends PlainGun{
	...
	public void shoot(Main main) {
		main.add(new Bullet(main,this.getFlyer().getX()-(int)(0.5*getFlyer().getSize())+(int)(this.getFlyer().getSize()/3),
				this.getFlyer().getY()-20,(int)this.getFlyer().getSpeedX(),20));
		main.add(new Bullet(main,this.getFlyer().getX()-(int)(0.5*getFlyer().getSize())+2*(int)(this.getFlyer().getSize()/3),
				this.getFlyer().getY()-20,(int)this.getFlyer().getSpeedX(),20));
