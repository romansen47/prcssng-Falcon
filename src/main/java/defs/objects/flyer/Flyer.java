...
public abstract class Flyer extends Ball implements IDrawable{
	...
	public void draw(Main main) {
		...
		main.shape(main.getFlyer(),getX()-(int)(0.5*getSize()),getY()-((int)(0.5*getSize())),getSize(),(int)getSize());
		...
		main.rect(getX()-((int)(0.5*getSize())),getY()-((int)(0.5*getSize())),(int)(1.0*health/maxHealth*getSize()),8);
		//main.stroke(0);
	}
