...
public class StarDestroyer extends EnemyFlyer{
	...
	public void draw(Main main) {
		...
		main.fill((int)(255*(this.getMaxHealth()-this.getHealth())/this.getMaxHealth()),
				(int)(255*this.getHealth()/this.getMaxHealth()),0);
		main.rect(getX()-((int)(0.5*getSize())),getY()-10,(int)((double)this.getHealth()/this.getMaxHealth()*getSize()),13*main.Height/1080);
	}
	...
	public void selfDestroy(Main main) {
		...
		main.add(new Explosion(main,getX()+(int)(0.5*getSize()),
				getY()+getSize()+10));
		main.setLevel(main.getLevel() + 1);
		main.setBoss(null);
		main.getChewBacca().trigger();
		((HanSolo)(main.getHanSolo())).setMaxHealth(
				((HanSolo)(main.getHanSolo())).getMaxHealth()+100);
		((HanSolo)(main.getHanSolo())).setMaxMuni(
					((HanSolo)(main.getHanSolo())).getMaxMuni()+100);
	}
