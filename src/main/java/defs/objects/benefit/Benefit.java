...
public class Benefit implements IDrawable{ 
	...
	public void draw(Main main) {
		main.shape(main.getBenefit(),getX()-((int)(0.5*getSize())),
								getY()-((int)(0.5*getSize())-20),
								getSize(),getSize());
		main.fill((int)(255*(getMaxhealth()-getHealth())/getMaxhealth()),(int)(255*getHealth()/getMaxhealth()),0);
		main.rect(getX()-((int)(0.5*getSize())),getY()-((int)(0.5*getSize()))-10,(int)(1.*getHealth()/getMaxhealth()*getSize()),8,50);
	}
	...
	public void move(Main main) {
		setY(getY()+7);
		if (main.getHanSolo().getY()<=getY()+getSize() && 
			main.getHanSolo().getX()<getX()+getSize() && 
