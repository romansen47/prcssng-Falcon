...
public class Main extends Gui{
	...
	/**
	 * Container for the EnemyFlyer instances. These instances interact when they collide
	 */
	 ...
	 * Sound samples 
	 */
	private AudioSample player,PlainGunSound,ExplosionSound,ChewBacca,
			han,Vader,yodaLaughter;
	 ...
	 * Various test data
	 */
	private PShape heart,explosion,muni,yoda,flyer,stardestroyer,
		deathStar,benefit,hansolo,asteroid,darth;
	...
	public void drawInformation() {
		fill((int)(255*(100-((HanSolo)getHanSolo()).getHealth())/((HanSolo)getHanSolo()).getMaxHealth()),
				(int)(255*((HanSolo)getHanSolo()).getHealth()/((HanSolo)getHanSolo()).getMaxHealth()),0);
		rect(30,30,(int)((this.Width/3)*((HanSolo)getHanSolo()).getHealth()/((HanSolo)getHanSolo()).getMaxHealth()),30);
	    shape(heart,40,30,30,30);

		fill(0,0,255);
		rect(30,80,(int)((this.Width/3)*((HanSolo)getHanSolo()).getMuni()/((HanSolo)getHanSolo()).getMaxMuni()),30);
	    shape(muni,40,80,30,30);
	    
	    fill(0,255,255);
	    rect(this.Width-300,30,280,60,25);
	    textSize(30);
	    fill(0);
	    text("Score: "+((HanSolo)(getHanSolo())).getScore(), Width-260, 80);
	}
